     ...
     return (
          <>
               ...
               <nav className={`w-full fixed px-4 sm:px-8 xl:px-[5%] py-0 flex items-center justify-between z-50 dark:backdrop-blur-md ${isScroll ? 'bg-transparent bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme/50 dark:shadow-white/20' : ''}`}>
                    ...
                    <ul ref={sideMenuRef} className='font-ovo flex lg:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-darkHover dark:text-white'>
                         ...
                         <li><Link href='#my-work' onClick={closeMenu}>My work</Link></li>
